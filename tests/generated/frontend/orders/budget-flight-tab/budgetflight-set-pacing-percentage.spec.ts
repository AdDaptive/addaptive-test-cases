...
test('BudgetFlight (Set Pacing Percentage)', async ({ page, loginAsDefaultUser, impersonateConfiguredUser }) => {
  ...
  // Original Katalon test case: Test Cases/Frontend/Orders/Budget Flight Tab/BudgetFlight (Set Pacing Percentage)
});
